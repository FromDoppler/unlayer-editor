...
export const wheelListWidget: WidgetComponent<WheelSlide[], void> = ({
  ...
  return (
    <div role="container" className="blockbuilder-widget row">
      Configuracion de casillas
      <div className="col-12">
        <Modal
          open={modalOpen}
          size="M"
          titleContent="Administrar Segmentos" //{$t('_dp.smart_forms.action.create_list')}
          primaryAction={{
            label: 'Actualizar',
                ...
                <table className="table ">
                  <thead>
                    <tr>
                      ...
                      <th style={headerStyle}>Premio</th>
                      <th style={headerStyle}>Chance</th>
                      <th>Probabilidad</th>
                      <th>Color</th>
                      <th>Acción</th>
                    </tr>
