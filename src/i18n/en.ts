...
export const messages_en: IntlMessages = {
  ...
  '_dp.size': `Size`,
  '_dp.small': `Small`,
  '_dp.smart_forms.action.empty_list': `Select a list`,
  '_dp.smart_forms.action.label': `Select a Subscription list`,
  ...
  '_dp.smart_forms.behavior.action.option_2': `Close Popup`,
  ...
  'tabs.audit.rules.smart_form.congrats_message_undefined.description': `To continue, you must write a Thank You Message, which your clients will see when submitting the form once they complete it.`,
  'tabs.audit.rules.smart_form.congrats_message_undefined.title': `Write a Thank You Message`,
  'tabs.audit.rules.smart_form.congrats_url_undefined.description': `To continue, you must enter a URL where your clients will be redirected once they submit the completed form.`,
  'tabs.audit.rules.smart_form.congrats_url_undefined.title': `Enter a target URL`,
  'tabs.audit.rules.smart_form.congrats_url_valid.description': `To continue, you must enter a valid URL where your clients will be redirected once they submit the completed form.`,
  'tabs.audit.rules.smart_form.congrats_url_valid.title': `Please enter a valid URL`,
  'tabs.audit.rules.smart_form.subscription_list_undefined.description': `To continue, you must select a List where the data entered by your clients in the form is stored.`,
