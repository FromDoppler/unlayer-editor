...
export const messages_en: IntlMessages = {
  ...
  'tabs.audit.rules.smart_form.congrats_url_invalid.description': `To continue, you must enter a valid URL where your clients will be redirected once they submit the completed form.`,
